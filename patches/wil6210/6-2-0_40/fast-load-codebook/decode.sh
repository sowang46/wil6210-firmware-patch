...
arc-elf32-objdump -D -b binary -m arc600 -EL dump/dump_0x008c0000.bin > dump/dump_0x008c0000.asm
linenum=$(cat dump/dump_0x008c0000.asm | grep -n "$1:" | awk {'print $1'} | sed 's/://')
cat dump/dump_0x008c0000.asm | head -n $(($linenum+$2-1)) | tail -n $2
